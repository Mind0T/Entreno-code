...
#Todo esto lo vi en el dataCamp
...
#este es el aporte w3shool
print('Aporte de W3School\n')
areas_copy4=areas.copy()
print(f"Aqui copie de nuevo la lista original pero con listaNueva=miListaOriginal.copy()\n{areas_copy4}\n") # igual si modifica la original la nueva no cambia
print("Igualmente si modificara la original la nueva ya no se cambia")